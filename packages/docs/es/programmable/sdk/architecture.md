...
description: Estructura del paquete, límites de la API pública y principios de diseño de @redrob-design/vue.
---

# Arquitectura del SDK

`@redrob-design/vue` conecta `@redrob-design/core` con Vue.
...
Si un fragmento de código puede utilizarse en otro editor basado en Redrob Design sin arrastrar los estilos de la aplicación, probablemente debe formar parte de `@redrob-design/vue`.
