...
El SDK público actual usa directamente `provideEditor()` y `useEditor()`. `Redrob DesignProvider`, mencionado en ejemplos antiguos, no forma parte de la API actual.
