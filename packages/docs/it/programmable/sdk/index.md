---
title: Vue SDK
description: Crea editor basati su Redrob Design con componenti senza stile e composable per Vue.
---

# Vue SDK

`@redrob-design/vue` permette di utilizzare Redrob Design non solo come applicazione di design autonoma.

Puoi integrare Redrob Design in altri prodotti, strumenti interni o editor specializzati senza adottare l'interfaccia predefinita dell'applicazione.

L’app Redrob Design è soltanto una delle interfacce realizzate con questo insieme di strumenti. L’SDK permette di crearne una personalizzata.
...
- **Una stretta integrazione con Vue:** l'SDK collega Vue alle funzionalità di `@redrob-design/core`.
