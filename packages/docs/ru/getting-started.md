...
Redrob Design работает прямо в браузере и не требует установки. Чтобы начать работу, откройте [app.redrob.design](https://app.redrob.design).

Если вы хотите создать на основе Redrob Design собственный продукт, а не только пользоваться готовым приложением, перейдите в раздел [Программирование и автоматизация](/programmable/) или прочитайте документацию [Vue SDK](/programmable/sdk/).
