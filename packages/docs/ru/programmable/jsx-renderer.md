...
Redrob Design использует JSX как декларативный язык создания дизайна. Он подходит для агентов ИИ, сценариев и воспроизводимого построения интерфейсов.
...
```sh
redrob-design export design.fig -f jsx                   # Формат Redrob Design
redrob-design export design.fig -f jsx --style tailwind  # Классы Tailwind
```
