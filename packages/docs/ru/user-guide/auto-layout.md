...
description: "Flexbox и CSS Grid в Redrob Design: направление, интервалы, отступы, выравнивание и размеры дочерних объектов."
---
...
При создании фрейма Redrob Design сначала сортирует объекты по их видимому положению.
