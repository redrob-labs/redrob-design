...
description: Development notes for Redrob Design boolean operations, flattening, text outlines, stroke outlines, and vector geometry conversion.
---

# Vector conversion

Redrob Design has a shared path-conversion pipeline for commands that turn scene nodes into vector geometry.
