...
description: Binden Sie @redrob-design/vue ein, erstellen Sie einen Editor und richten Sie die Arbeitsfläche ein.
---
...
Das SDK befindet sich im Redrob Design-Monorepo und wird als Paket `@redrob-design/vue` veröffentlicht.
...
1. `@redrob-design/core` — die vom Framework unabhängige Editor-Engine;
2. `@redrob-design/vue` — Composables und Komponenten ohne vorgegebenes Erscheinungsbild für Vue;
