...
description: Paketstruktur, Grenzen der öffentlichen API und Gestaltungsprinzipien von @redrob-design/vue.
---

# SDK-Architektur

`@redrob-design/vue` verbindet `@redrob-design/core` mit Vue.
...
Kann Code ohne die Gestaltung der Anwendung in einem anderen Redrob Design-basierten Editor wiederverwendet werden, gehört er wahrscheinlich in `@redrob-design/vue`.
