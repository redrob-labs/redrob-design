---
title: Vue SDK
description: Erstellen Sie Redrob Design-basierte Editoren mit Komponenten ohne vorgegebenes Erscheinungsbild und Vue Composables.
---

# Vue SDK

Mit `@redrob-design/vue` lässt sich Redrob Design nicht nur als eigenständige Designanwendung verwenden.

Redrob Design kann in andere Produkte, interne Werkzeuge oder auf bestimmte Aufgaben zugeschnittene Editoren eingebettet werden. Dabei sind Sie nicht an die Benutzeroberfläche der Redrob Design-App gebunden.

Die Redrob Design-App ist lediglich eine mögliche Oberfläche, die mit diesem Toolkit erstellt wurde. Mit dem SDK können Sie eine eigene entwickeln.
...
- **Enge Vue-Integration:** Das SDK verbindet Vue mit den Funktionen von `@redrob-design/core`.
