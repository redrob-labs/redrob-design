...
```sh
redrob-design export design.fig                           # PNG domyślnie
redrob-design export design.fig -f jpg -s 2 -q 90        # JPG, skala 2×, jakość 90
redrob-design export design.fig -f webp -s 3             # WEBP, skala 3×
redrob-design export design.fig -f svg                   # SVG
redrob-design export design.fig -f fig --page "Page 1"   # Jedna strona w osobnym .fig
redrob-design export design.fig -f fig --node 1:23        # Jeden obiekt w osobnym .fig
redrob-design export design.fig -f html --css tailwind    # Fragment HTML z klasami Tailwind
```
...
```sh
redrob-design export -f png    # Zrzut bieżącego obszaru roboczego
```
