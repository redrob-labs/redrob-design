import type { DocumentColorSpace, SceneNode } from '@redrob-design/scene-graph'
import { copyEffects, copyFill, copyStyleRuns, copyStroke } from '@redrob-design/scene-graph/copy'
